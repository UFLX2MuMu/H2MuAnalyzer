...
/////////////////////////////////////////////////////////////////////////
JetCorrectionUncertainty_x::JetCorrectionUncertainty_x () 
{
  mJetEta = -9999;
  mJetPt  = -9999;
  mJetPhi = -9999;
  ...
  mIsLepPzset  = false;
  mAddLepToJet = false;
  mUncertainty = new SimpleJetCorrectionUncertainty_x();
}
/////////////////////////////////////////////////////////////////////////
JetCorrectionUncertainty_x::JetCorrectionUncertainty_x(const std::string& fDataFile)  
{
  mJetEta = -9999;
  mJetPt  = -9999;
  mJetPhi = -9999;
  ...
  mIsLepPzset  = false;
  mAddLepToJet = false;
  mUncertainty = new SimpleJetCorrectionUncertainty_x(fDataFile);
}
/////////////////////////////////////////////////////////////////////////
JetCorrectionUncertainty_x::JetCorrectionUncertainty_x(const JetCorrectorParameters_x& fParameters)  
{
  mJetEta = -9999;
  mJetPt  = -9999;
  mJetPhi = -9999;
  ...
  mIsLepPzset  = false;
  mAddLepToJet = false;
  mUncertainty = new SimpleJetCorrectionUncertainty_x(fParameters);
}
/////////////////////////////////////////////////////////////////////////
JetCorrectionUncertainty_x::~JetCorrectionUncertainty_x () 
{
...
/////////////////////////////////////////////////////////////////////////
void JetCorrectionUncertainty_x::setParameters(const std::string& fDataFile) 
{
...
/////////////////////////////////////////////////////////////////////////
float JetCorrectionUncertainty_x::getUncertainty(bool fDirection) 
{
  float result;
...
//------------------------------------------------------------------------
std::vector<float> JetCorrectionUncertainty_x::fillVector(const std::vector<std::string>& fNames)
{
  ...
  for(unsigned i=0;i<fNames.size();i++)
	...
	std::cout <<" unknown parameter " << fNames[i] << std::endl;
	result.push_back(-999.0);
      }
    }     
  return result;      
...
//------------------------------------------------------------------------
float JetCorrectionUncertainty_x::getPtRel()
{
  ...
  if (lj2 > 0) {
    ...
    std::cout <<" not positive lepton-jet momentum: "<<lj2 << std::endl;
  return (pTrel2 > 0) ? std::sqrt(pTrel2) : 0.0;
}
//------------------------------------------------------------------------ 
//--- Setters ------------------------------------------------------------
//------------------------------------------------------------------------
void JetCorrectionUncertainty_x::setJetEta(float fEta)
{
  mJetEta = fEta;
  mIsJetEtaset = true;
}
//------------------------------------------------------------------------
void JetCorrectionUncertainty_x::setJetPt(float fPt)
{
  mJetPt = fPt;
  mIsJetPtset  = true;
}
//------------------------------------------------------------------------
void JetCorrectionUncertainty_x::setJetPhi(float fPhi)
{
  mJetPhi = fPhi;
  mIsJetPhiset  = true;
}
//------------------------------------------------------------------------
void JetCorrectionUncertainty_x::setJetE(float fE)
{
  mJetE = fE;
  mIsJetEset   = true;
}
//------------------------------------------------------------------------
void JetCorrectionUncertainty_x::setJetEMF(float fEMF)
{
  mJetEMF = fEMF;
  mIsJetEMFset = true;
}
//------------------------------------------------------------------------
void JetCorrectionUncertainty_x::setLepPx(float fPx)
{
  mLepPx = fPx;
  mIsLepPxset  = true;
}
//------------------------------------------------------------------------
void JetCorrectionUncertainty_x::setLepPy(float fPy)
{
  mLepPy = fPy;
  mIsLepPyset  = true;
}
//------------------------------------------------------------------------
void JetCorrectionUncertainty_x::setLepPz(float fPz)
{
  mLepPz = fPz;
  mIsLepPzset  = true;
}
